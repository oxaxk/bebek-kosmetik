    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between">
          ...
          <button 
            className="md:hidden bg-white/90 backdrop-blur-sm rounded-lg p-2 shadow-md border border-stone-200 cursor-pointer"
            onClick={toggleMobileMenu}
          >
            <i className={`text-2xl text-stone-700 transition-transform duration-300 ${
        ...
        <div className={`md:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-md shadow-lg border-t border-stone-200 transition-all duration-300 ${
          ...
          <nav className="container mx-auto px-6 py-6">
            <div className="flex flex-col space-y-4">
              <button 
                onClick={() => handleNavigation('about')}
                className="text-lg text-stone-700 hover:text-amber-700 transition-colors cursor-pointer font-medium text-left py-2 border-b border-stone-200 whitespace-nowrap"
              >
                Über uns
              </button>
              <button 
