      ...
      <div className="container mx-auto px-6 text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl lg:text-5xl font-bold text-stone-800 mb-6" style={{ fontFamily: 'Playfair Display, serif' }}>
            Termin buchen und <span className="text-amber-700">Glow spüren</span>
          </h2>
          ...
          <div className="flex justify-center items-center gap-6">
            ...
            <button 
              ...
              className="bg-amber-700 hover:bg-amber-800 text-white px-12 py-5 rounded-full font-bold text-xl transition-colors cursor-pointer whitespace-nowrap shadow-lg"
            >
              Jetzt Termin buchen
            </button>
          </div>
