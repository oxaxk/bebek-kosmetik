      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-stone-900 mb-6" style={{ fontFamily: 'Playfair Display, serif' }}>
            Ein Blick in unser <span className="text-[#4A331F]">Studio</span>
          </h2>
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 text-[#4A331F] hover:text-[#2F1F13] font-semibold text-lg transition-colors"
          >
